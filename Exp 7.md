...
The Android device was successfully connected to the computer using **ADB**, and **AFLogical OSE** was used to perform logical extraction of available Android data. The extracted contacts, SMS, MMS, and call-log information was transferred to the computer as CSV files for further forensic analysis and documentation.Connect the Android device to the computer using a USB cable.
